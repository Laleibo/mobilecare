class UberRideRequest < ApplicationRecord
  ...
  def self.lyft_ride
    ...
    header = {'Authorization' => ' Bearer SANDBOX-gAAAAABXsEM-nuXlcwrHMNIQkxh9ulGw2lOrcI3Y9A66wJd-xJne0FluFaa-P7nxaAdrTbVSuyaXsenRAeo3Hem69vWh01YJdSrnJ5L4uUEPFSvHBFebJ3zzww9XHd6Mu35hz7TAeBJYn-RXE8x-pRZhZ_wRnmgclu4hVuZfw0YdxC1VikkQbJL0oDIR4H6v3sLFD_nK6rI3rK4znn9i24F0-0j7SzCT4D_t6_eKw-ttGUmLLlrAd7ZYFbmYAg7DIIztz4_IEpsa', 'Content-Type' => 'application/json'}
  HTTParty.post("https://api.lyft.com/v1/rides", headers: header, body: body )
  end
end
